...
function GradientButton({ href, children, external, fitCall }: { href: string; children: React.ReactNode; external?: boolean; fitCall?: boolean }) {
          ...
          <AnimateIn delay={0.3} className="mt-10">
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                { title: "Start with a call", body: "A 30-minute conversation to figure out whether there is a real fit.", href: "https://calendly.com/bob-successfulbob", external: true },
              ].map((item, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, y: 16 }}
