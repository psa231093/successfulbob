              ...
              <StaggerItem key={p.name} className="h-full">
                ...
                >
                  ...
                  <div className="mt-auto">
                    ...
                    {p.featured ? (
                      <GradientButton href="https://calendly.com/bob-successfulbob" external>{p.cta}</GradientButton>
                    ) : (
                      <OutlineButton href="https://calendly.com/bob-successfulbob" external>{p.cta}</OutlineButton>
                    )}
                  </div>
                </motion.div>
              </StaggerItem>
          ...
          <AnimateIn delay={0.15}>
            <div className="rounded-2xl px-7 py-6 bg-[#f5f7fb] border border-[#e5e7eb] flex flex-col sm:flex-row sm:items-center justify-between gap-5">
              ...
              <div className="sm:w-auto w-full sm:flex-shrink-0">
                <OutlineButton href="https://calendly.com/bob-successfulbob" external>Schedule a Fit Call</OutlineButton>
              </div>
            </div>
          </AnimateIn>
        </div>
