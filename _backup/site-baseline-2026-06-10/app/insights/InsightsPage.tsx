...
/* --- CMS-ready data --------------------------------------------
   These constants are shaped to be swapped for a Sanity/MDX fetch
   later with no UI change: replace the arrays with fetched data of
   the same shape. Detail routes (/insights/[slug]) arrive with the
   CMS phase; links currently render as styled cards.
----------------------------------------------------------------- */
...
const CATEGORIES = [
  ...
  {
    name: "Demos & Field Conversations",
...
const POSTS = [
  { slug: "founder-led-sales-stops-scaling", category: "Founder Led Sales", title: "When does founder led sales stop scaling?", excerpt: "The warning signs that the founder has become the bottleneck, and what to build before hiring more salespeople.", date: "May 2026" },
  { slug: "demo-feature-tour", category: "Demos & Field Conversations", title: "How to stop a demo from becoming a feature tour", excerpt: "A structure for showing less, meaning more, and guiding buyers toward a business reason to care.", date: "May 2026" },
  { slug: "technical-value-executives", category: "Executive Narrative", title: "How do you explain technical value to executives?", excerpt: "Translating architecture and capability into cost, risk, security, agility, and efficiency the board can follow.", date: "Apr 2026" },
  { slug: "product-messaging-framework", category: "Product Messaging", title: "What is a product messaging framework?", excerpt: "How to connect what the product does to what buyers actually act on, in a way the whole team can repeat.", date: "Apr 2026" },
  { slug: "partner-messaging-repeatable", category: "Partner Enablement", title: "How do you make partner messaging repeatable?", excerpt: "Why partner interest rarely turns into partner repeatability, and the enablement structure that fixes it.", date: "Mar 2026" },
  { slug: "gtm-strategy-startups", category: "Startup Go to Market", title: "What is a go to market strategy for startups?", excerpt: "A practical definition, minus the theory no one uses, for technical founders bringing a product to market.", date: "Mar 2026" },
];
...
/* --- Newsletter signup (styled placeholder) -------------------- */
              ...
              >
                ...
                <div className="p-8 md:p-12 order-2 md:order-1">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full mb-5"
                    ...
                    <span className="w-1.5 h-1.5 rounded-full" style={{ background: "linear-gradient(135deg, #3f6bff, #8b5cf6)" }} />
                    <span className="text-[11px] font-semibold tracking-[0.1em] uppercase text-[#3f6bff]">Featured · {FEATURED.category}</span>
                  </div>
                  ...
                  <p className="text-[#526078] text-[15px] md:text-[16px] leading-[1.75] mb-6">{FEATURED.summary}</p>
          ...
          <Stagger className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5" stagger={0.07}>
            {CATEGORIES.map((c) => (
              <StaggerItem key={c.name} className="h-full">
                ...
                >
                  <h3 className="text-[18px] font-bold text-[#111827] mb-2.5 group-hover:text-[#3f6bff] transition-colors duration-200">{c.name}</h3>
                  <p className="text-[#526078] text-[14px] leading-[1.65] mb-5">{c.blurb}</p>
                  ...
                  >
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      ...
                      <div className="mt-auto flex items-center justify-between pt-4 border-t border-[#f0f1f4]">
                        <span className="text-[13px] text-[#9ca3af]">{p.date}</span>
            ...
            <div className="rounded-3xl p-8 md:p-12 relative overflow-hidden"
              ...
              <div className="relative md:flex md:items-center md:justify-between gap-8">
                ...
                <div className="flex flex-col gap-3 md:flex-shrink-0 md:w-56">
                  ...
                  <GhostButton href="https://calendly.com/bob-successfulbob" external>Schedule a Fit Call</GhostButton>
                </div>
              </div>
            </div>
          </AnimateIn>
